...
**Uža okolina nije donela bolji rezultat.** Okolina zasnovana na kritičnom putu smanjuje broj kandidata po koraku između 80 i 260 puta, ali pri izjednačenom budžetu daje lošije rezultate od proste zamene dva elementa, i to u svim ispitanim postavkama. Razlozi za ovaj rezultat jesu (1) činjenica da smanjivanje okoline daje plići pojam lokalnog optimuma, (2) gubitak neutralnih poteza kod simuliranog kaljenja i (3) aproksimirana implementacija u okviru eksperimenta (više u sekciji 3.8.2). Vredi naglasiti da usvojeno merilo budžeta pritom **ne radi na štetu** uže okoline, iako se to nametalo kao potencijalni nedostatak postavke eksperimenata.^[Kao što je napomenuto u sekciji 3, pretpostavljamo da bi se rezultati značajno poboljšali uvođenjem strukture samog problema u metaheuristike, pre svega kroz tabu listu i inkrementalnu procenu vrednosti.]
...
Implementacija $N_1$ okoline je aproksimativne prirode i ne oslikava vernu definiciju $N_1$ okolina koja se pominje u literaturi. Zbog toga, zaključi o njenom uticaju se mogu donositi samo u okviru date implementacije a ne i generalizovati nad standardnim $N_1$ okolinama.
